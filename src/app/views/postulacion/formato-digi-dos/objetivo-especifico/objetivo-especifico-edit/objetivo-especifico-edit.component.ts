...
@Component({
  selector: 'app-objetivo-especifico-edit',
  standalone: true,
    imports: [
      CommonModule,
      CommonMaterialModule
    ],
  templateUrl: './objetivo-especifico-edit.component.html',
  styleUrl: './objetivo-especifico-edit.component.scss'
})
export class ObjetivoEspecificoEditComponent implements OnInit{

  formulario: FormGroup
  role:number

  constructor(public dialogRef: MatDialogRef<ObjetivoEspecificoEditComponent>,
